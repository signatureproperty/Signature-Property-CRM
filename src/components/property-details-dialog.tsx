            ...
            <div className="space-y-8 pb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-3 rounded-xl bg-muted/20 border border-border/30 text-sm italic text-muted-foreground">
              ...
              {property.message && !property.is_for_rent && (
                <div className="space-y-3">
                  ...
                  <div className="p-4 rounded-xl bg-muted/20 border border-dashed border-border/30 text-sm text-foreground">
                    {property.message}
                  </div>
                </div>
              )}

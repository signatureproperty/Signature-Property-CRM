            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <StatCard icon={<Landmark className="h-5 w-5" />} label="Grand Total" value={(stats as any).totalProperties} colorClass="bg-primary/10 text-primary" />
                  <StatCard icon={<Wallet className="h-5 w-5" />} label="For Sale" value={(stats as any).saleProperties} subLabel="Active Listings" colorClass="bg-sky-500/10 text-sky-600" />
                  <StatCard icon={<Key className="h-5 w-5" />} label="For Rent" value={(stats as any).rentProperties} subLabel="Available Portions" colorClass="bg-emerald-500/10 text-emerald-600" />
                </div>
              </div>
              <div className="space-y-4">
                <h3 className="text-xs font-bold uppercase tracking-widest text-muted-foreground flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <StatCard icon={<Users className="h-5 w-5" />} label="Total Leads" value={(stats as any).totalBuyers} colorClass="bg-indigo-500/10 text-indigo-600" />
                  <StatCard icon={<Landmark className="h-5 w-5" />} label="Sale Buyers" value={(stats as any).saleBuyers} subLabel="Buying Leads" colorClass="bg-violet-500/10 text-violet-600" />
                  <StatCard icon={<Key className="h-5 w-5" />} label="Rent Buyers" value={(stats as any).rentBuyers} subLabel="Rental Inquiries" colorClass="bg-teal-500/10 text-teal-600" />
                </div>
              </div>
            </div>
          </div>
